...
def object_list_to_table(headings, dict_list):
    ...
    """
    return [headings] + [tuple([getattr_by_path(row, heading, None) for heading in headings]) for row in dict_list]
...
def dict_list_to_table(headings, dict_list):
    ...
    """
    return [headings] + [tuple([row[heading] for heading in headings]) for row in dict_list]
